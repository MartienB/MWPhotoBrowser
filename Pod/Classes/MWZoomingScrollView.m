...
- (CGFloat)initialZoomScaleWithMinScale {
    ...
    if (_photoImageView && _photoBrowser.zoomPhotosToFill) {
        ...
        CGFloat xScale = (boundsSize.width - 0) / imageSize.width;    // the scale needed to perfectly fit the image width-wise
        CGFloat yScale = (boundsSize.height - 80) / imageSize.height;  // the scale needed to perfectly fit the image height-wise
